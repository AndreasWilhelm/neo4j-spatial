...
/**
 * The <code>ST_Intersect</code> class returns geometries that have at least one
 * point in common with the given geometry.
 * 
 * @author Davide Savazzi, Andreas Wilhelm
 */
public class ST_Intersect extends AbstractReadOperation {

	private Geometry other = null;

	public ST_Intersect(Geometry other) {
		this.other = other;
	}
